...
> This feature was added to augment the [**PayPal button**](../paypal.html) functionality by providing secure and controlled access to the downloadable digital products being sold. However it can be used with any other links that have similar needs.</p>
...
If you'd rather have the download box shown for all types of files, set the *force_download* parameter to '1'.<br/>
